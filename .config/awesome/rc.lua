...
local theme_path = string.format("%s/.config/awesome/themes/%s/theme.lua", os.getenv("HOME"), "luke")
...
mytextclock = wibox.widget.textclock(' %b %d, %Y (%a) %r ', .1)
-- Create the systray with correct padding
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "q", awesome.restart,
              {description = "reload awesome", qroup = "awesome"}),
